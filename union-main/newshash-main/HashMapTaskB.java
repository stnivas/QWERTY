...
//Question17
   public HashMap<String,String> replaceValueSame (String[] animalKey, String[]animalValues,String keyName, String oldValue, String newValue){
	  ...
	  case 5:
	   ...
	   case 12:
    	...
    	case 16:
		     ...
		     HashMap<String,String>mapSixteen=obj.replaceValue(animalKey,animalValues, keyName,valueName);
		...
		case 17:
		     ...
		     HashMap<String,String>mapSeventeen=obj.replaceValueSame(animalKey,animalValues, keyName, oldValue,newValue);
		...
		case 19:
		     ...
		     HashMap<String,String>mapNineteen=obj.removeExistingKey(keys,values);
		     System.out.println(" after HashMap="+mapNineteen);
		     System.out.println(" after HashMap size="+mapNineteen.size());
		     System.out.println(" Run successfully");
		break;
